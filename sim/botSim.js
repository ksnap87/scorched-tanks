...
const TANK_TYPES = {
  K2:    { id: 'K2',    flag: '🇰🇷', hp: 125, range: 0.85, move: 150, moveSpeed: 2.0,
           ammo: { damage: 32, radius: 11 },
           bomb2: { kind: 'redbean', damage: 65, radius: 8, range: 1.3 },
           ultimate: { kind: 'army_missile', damage: 78, radius: 12, terrainRadius: 18 } },
  M1A2:  { id: 'M1A2',  flag: '🇺🇸', hp: 140, range: 1.0, move: 95, moveSpeed: 1.4,
           ammo: { damage: 30, radius: 12 },
           bomb2: { kind: 'multi', damage: 13, radius: 4, multi: 4, multiSpreadPx: 28 },
           ultimate: { kind: 'b2_carpet', damage: 40, radius: 42, terrainRadius: 16 } },
  T90:   { id: 'T90',   flag: '🇷🇺', hp: 128, range: 1.2, move: 130, moveSpeed: 1.3,
           ammo: { damage: 36, radius: 6, pierce: 1.20 },
           bomb2: { kind: 'uranium', damage: 15, radius: 12, dotRadius: 28, dotDps: 3, dotDuration: 9 },
           ultimate: { kind: 'drone_grenade', damage: 38, radius: 8, terrainRadius: 10 } },
  T10:   { id: 'T10',   flag: '🇯🇵', hp: 110, range: 0.65, move: 175, moveSpeed: 2.4,
           ammo: { damage: 29, radius: 10 },
           bomb2: { kind: 'guided', damage: 38, radius: 14, range: 0.95 },
           ultimate: { kind: 'kamikaze', damage: 58, radius: 24, terrainRadius: 22 } },
  ZTZ99: { id: 'ZTZ99', flag: '🇨🇳', hp: 118, range: 0.55, move: 125, moveSpeed: 1.4,
           ammo: { damage: 28, radius: 15 },
           bomb2: { kind: 'shotgun', damage: 18, radius: 30, fire: { radius: 42, dps: 2.5, duration: 8 } },
           ultimate: { kind: 'satellite_laser', damage: 70, radius: 5, terrainRadius: 28 } },
  LEO2:  { id: 'LEO2',  flag: '🇩🇪', hp: 88, range: 1.5, move: 115, moveSpeed: 1.0,
           ammo: { damage: 36, radius: 16, pierce: 1.20 },
           bomb2: { kind: 'laser_beam', damage: 34, range: 250, beamWidth: 8 },
           ultimate: { kind: 'stuka_dive', damage: 44, radius: 15, terrainRadius: 15 } },
};
